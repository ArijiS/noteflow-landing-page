  ...
  return (
    <section className="noise-bg-dark">
        <div className="relative max-w-360 px-25 max-xl:px-16 max-lg:px-8 max-md:px-6 py-32 max-xl:py-24 m-auto z-0">
            ...
            <h2 className="text-6xl/[4.5rem] max-xl:text-5xl/[3.5rem] max-lg:text-4xl/10 font-semibold tracking-tighter max-lg:tracking-tight text-center mb-28 max-xl:mb-18">All The Tools You Need to<br/>
            ...
            <div className="grid grid-cols-2 max-md:grid-cols-1 items-center gap-x-16 max-md:gap-y-10 max-xl:gap-x-10 mb-20 max-xl:mb-12 max-md:mb-16">
                <figure className="relative">
                    ...
                    <img src={SmartOrganization} alt="" className="max-h-180 max-md:max-w-[90%] justify-self-center relative"/>
                </figure>
                <div className="max-w-lg max-md:max-w-max justify-self-end max-md:justify-self-start max-md:row-start-1">
                    <p className="text-5xl/14 max-xl:text-4xl/10 max-lg:text-3xl/12 tracking-tighter max-lg:tracking-tight mb-8 max-xl:mb-6 max-lg:mb-4 font-semibold">Smart Organization</p>
            ...
            <div className="grid grid-cols-2 max-md:grid-cols-1 items-center gap-x-16 max-md:gap-y-10 max-xl:gap-x-10">
                <div className="max-w-lg max-md:max-w-max justify-self-start">
                    <p className="text-5xl/14 max-xl:text-4xl/10 max-lg:text-3xl/12 tracking-tighter max-lg:tracking-tight mb-8 max-xl:mb-6 max-lg:mb-4 font-semibold">Contextual Reminders</p>
                ...
                <figure className="relative">
                    ...
                    <img src={ContextualReminders} alt="" className="relative max-h-180 max-md:max-w-[90%] justify-self-end max-md:justify-self-center"/>
                </figure>
            </div>
