...
const Testimonial = ({testimonial}) => {
  return (
    <motion.li className="bg-primary-1300 py-10 max-md:py-8 px-8 max-xl:px-6 rounded-2xl"
      initial={{opacity:0, y:40}}
      whileInView={{opacity:1, y:0}}
      viewport={{once:true, amount:0.75}}
      transition={{opacity:{duration: 0.75, ease: easeInOut}}}
    >
      <div className="flex mb-8 max-md:mb-6 gap-x-1">
        {
        ...
        <div className="mt-16 max-xl:mt-12 max-md:mt-8 flex gap-x-6 max-xl:gap-x-4 items-center">
