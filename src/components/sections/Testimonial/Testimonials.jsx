...
const Testimonials = () => {
  ...
  return (
    <section className="noise-bg-light-to-dark">
        <div className="max-w-360 px-25 max-xl:px-16 max-lg:px-8 max-md:px-6 py-32 max-xl:py-24 m-auto flex flex-col items-center">
            ...
            <div className="max-w-210 flex flex-col justify-center items-center m-auto gap-y-6 max-lg:gap-y-4 mb-20 max-xl:mb-16">
                ...
                <p className="text-xl/10 max-lg:text-lg/8 max-sm:text-base/8 text-primary-100 tracking-normal text-center max-w-154 max-md:max-w-max">NoteFlow has helped 1000's supercharge their productivity with cutting edge AI note taking tools</p>
            </div>
