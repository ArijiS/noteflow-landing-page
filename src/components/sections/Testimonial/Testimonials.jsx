  ...
  return (
    <section className="noise-bg-light-to-dark">
        <div className="max-w-360 px-25 py-32 m-auto flex flex-col items-center">
            ...
            <button className="text-lg font-light tracking-normal w-50 h-16 rounded-full border-2 border-primary-50 cursor-pointer hover:bg-primary-50 hover:text-primary-1300 transition-properties flex gap-x-3 items-center group justify-center" onClick={ ()=> setExpanded( (prev) => !prev ) }>
