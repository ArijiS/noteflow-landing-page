  ...
  return (
    <section className="noise-bg-dark-to-light">
        <div className="max-w-360 px-25 max-xl:px-16 max-lg:px-8 max-md:px-6 py-32 max-xl:py-24 m-auto">
            ...
            <h2 className="text-6xl/[4.5rem] max-xl:text-5xl/[3.5rem] max-lg:text-4xl/[3rem] font-semibold tracking-tighter max-lg:tracking-tight text-center max-md:text-left mb-8 max-xl:mb-6 max-lg:mb-4 ">Frequently Asked Questions</h2>
            <p className="text-xl/10 max-lg:text-lg/8 font-light text-primary-100 text-center max-md:text-left mb-8 max-xl:mb-6">The most commonly asked questions about NoteFlow. <br className="max-md:hidden"/>
